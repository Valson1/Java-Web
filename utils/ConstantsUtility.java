...
public class ConstantsUtility {
    ...
    public static final int PURCHASE_NUMBER_FIELDS = 3;
    public static final int DISCOUNT_PURCHASE_NUMBER_FIELDS = 4;

    public static final String DOT = ".";
    public static final String SPACE = " ";
    public static final String PURCHASE_CLASS_NAME = "Purchase";
    public static final String DISCOUNT_PURCHASE_CLASS_NAME = "Discount Purchase";
