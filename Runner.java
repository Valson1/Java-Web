...
public class Runner {
	...
	// create purchase3
	Purchase<Product,Integer> purchase3 = new Purchase<>(new DiscountProduct("sugar", new Byn(280), new Byn(10)), 60);
	// create instance purchaseUtils3 without purchase instance
	PurchaseUtils<Service,Double> purchaseUtils3 = new PurchaseUtils<>(new Service("gym workout", new Byn(7560), 5),2.25);
	// output item of last purchase
	Service service2 = purchaseUtils3.getPurchase().getItem();
