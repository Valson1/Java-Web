...
public class ConstantUtils {
    ...
    public final static String NUMBER_UNPASSED_TRIALS_HEADER = "Number of passed trials";        
    public final static String ALL_TRIALS_MARKS_SUM_HEADER = "Marks sum of all trials: ";        
    public final static String UNPASSED_TRIALS_HEADER = "Unpassed trials";        
